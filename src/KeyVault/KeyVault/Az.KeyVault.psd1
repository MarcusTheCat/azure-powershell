...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Fixed ''New-AzKeyVault'' ''RequestDisallowedByPolicy'' error by explicitly setting ''enableSoftDelete'' in the request body to satisfy Azure Policy checks'

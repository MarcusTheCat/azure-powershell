...
RequiredAssemblies = 'PolicyInsights.Autorest/bin/Az.PolicyInsights.private.dll'
...
FormatsToProcess = 'PolicyInsights.Autorest/Az.PolicyInsights.format.ps1xml'

# Modules to import as nested modules of the module specified in RootModule/ModuleToProcess
NestedModules = @('PolicyInsights.Autorest/Az.PolicyInsights.psm1')

# Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
FunctionsToExport = 'Get-AzPolicyAttestation', 'Get-AzPolicyEvent', 
               ...
               'Remove-AzPolicyRemediation', 'Start-AzPolicyComplianceScan', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* The output type of ''Get-AzPolicyAttestation'', ''New-AzPolicyAttestation'', and ''Set-AzPolicyAttestation'' will change from ''PSAttestation'' to ''Attestation''

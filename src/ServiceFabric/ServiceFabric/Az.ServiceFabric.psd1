...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added ''Get-AzServiceFabricManagedClusterMaintenanceWindowStatus'' cmdlet to retrieve the maintenance window status of a Service Fabric Managed Cluster, including whether the window is enabled, active, and recent activity timestamps.'

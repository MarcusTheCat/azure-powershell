...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added ''-InstantAccess'' parameter to ''New-AzRestorePointCollection'' cmdlet to enable instant access snapshots for restore points on Premium SSD v2 and Ultra disks
